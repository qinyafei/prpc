...
class RpcMessage : public ::google::protobuf::Message {
 public:
  ...
  ::protorpc::MessageType type() const;
  void set_type(::protorpc::MessageType value);
...
inline ::protorpc::MessageType RpcMessage::type() const {
  // @@protoc_insertion_point(field_get:protorpc.RpcMessage.type)
  return static_cast< ::protorpc::MessageType >(type_);
}
inline void RpcMessage::set_type(::protorpc::MessageType value) {
...
inline ::protorpc::ErrorCode RpcMessage::error() const {
  // @@protoc_insertion_point(field_get:protorpc.RpcMessage.error)
  return static_cast< ::protorpc::ErrorCode >(error_);
}
inline void RpcMessage::set_error(::protorpc::ErrorCode value) {
...
template <> struct is_proto_enum< ::protorpc::MessageType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::protorpc::MessageType>() {
  return ::protorpc::MessageType_descriptor();
}
template <> struct is_proto_enum< ::protorpc::ErrorCode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::protorpc::ErrorCode>() {
  return ::protorpc::ErrorCode_descriptor();
}
